    ...
    return (
      <div>
        <div className="date-pickers-container">
          ...
          >
            <Popover>
              <Button icon="time" text={this.state.date.toDateString()} />
              <DatePicker onChange={this.onDateChanged} value={this.state.date} />
            </Popover>
          </FormGroup>
          <FormGroup label="Start Time">
            <TimePicker onChange={this.onStartChanged} value={this.state.start} precision={TimePrecision.MINUTE} />
          </FormGroup>
          <FormGroup label="Time (in hrs)">
            <NumericInput onValueChange={this.onEndChanged} value={this.state.length} min={1} max={100} />
          </FormGroup>
        </div>
        <div className="date-pickers-container">
          <Button
