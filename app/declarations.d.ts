...
declare module "apisauce" {
  ...
  export interface ApisauceInstance {
    ...
    post: <T>(url: string, data: {}, axiosConfig?: AxiosRequestConfig) => Promise<ApiResponse<T>>;
    put: <T>(url: string, data: {}, axiosConfig?: AxiosRequestConfig) => Promise<ApiResponse<T>>;
    patch: <T>(url: string, data: {}, axiosConfig?: AxiosRequestConfig) => Promise<ApiResponse<T>>;
  }
