...
import { Card, RegSuit, RegValue, RegValues, Suit, TrumpValue } from "../../../server/play/model/Card";
...
function buildTrump() {
  const trump: Card[] = [];
  for (let i = 1; i <= 21; i++) {
    trump.push(["T", `${i}` as TrumpValue]);
  }
  return trump;
}

const Clubs: Card[] = buildSuit("C");
const Diamonds: Card[] = buildSuit("D");
const Hearts: Card[] = buildSuit("H");
const Spades: Card[] = buildSuit("S");
const Trump: Card[] = buildTrump();
const Joker: Card = ["T", "Joker"];

export const RulesContainer = memo(function RulesContainer() {
  return (
    <Container size="lg">
      <h1>How to Play</h1>
      <p>
      ...
      <Center>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Clubs[4])} />
          <Title fs="italic" order={6}>
            Clubs
          </Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Diamonds[0])} />
          <Title fs="italic" order={6}>
            Diamonds
          </Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Hearts[11])} />
          <Title fs="italic" order={6}>
            Hearts
          </Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Spades[6])} />
          <Title fs="italic" order={6}>
            Spades
          </Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Trump[14])} />
          <Title fs="italic" order={6}>
            Trump
          </Title>
        </Stack>
      ...
      <p>
        Each of the regular suits has 14 cards. They consist of the numbers 1 through 10, and then four facecards which
        are a little different that the ones in a standard deck. Here are all of the clubs listed in order of lowest to
        highest.
      </p>

      <Group gap={0}>
        {Clubs.map((card, i) => (
          <Image key={i} w={100} src={getCardUrl(card)} />
        ))}
      </Group>
      ...
      <Center>
        <Image w={100} src={getCardUrl(Joker)} />
      </Center>
      ...
      <p>
        In person, the deck is traditionally left fairly unshuffled and cards are dealt 3 at a time in hopes of getting
        more variance in the hand strengths.
      </p>

      <h3>Play Phase and Tricks</h3>
      ...
      <ol>
        ...
        <li>
          If you have no cards in hand that match the suit of the trick, but you have trump cards in hand, you must play
          one of them.
        </li>
        <li>
      ...
      <p>
        In person, once a player has won a trick, they will collect it and create a pile of all the cards of tricks they
        have won.
        <span className="important-text">
          &nbsp;Note, unlike other trick taking games, the number of tricks won is not important, and so the cards are
          usually just piled together. As tarot is a team game, you will also combine your winnings with your teammates'
          to make things easier once you know who your teammates are.
        </span>
      </p>
      ...
      <p>For non-trump Ccard, all non-face cards are worth 0.5 points. The face cards are worth more, as shown here.</p>

      <Group justify="center" gap={0}>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Hearts[0])} />
          <Title order={6}>0.5</Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Hearts[9])} />
          <Title order={6}>0.5</Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Hearts[10])} />
          <Title order={6}>1.5</Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Hearts[11])} />
          <Title order={6}>2.5</Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Hearts[12])} />
          <Title order={6}>3.5</Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Hearts[13])} />
          <Title order={6}>4.5</Title>
        </Stack>
      </Group>
      ...
      <Group justify="center" gap={0}>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Trump[1])} />
          <Title order={6}>0.5</Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Trump[10])} />
          <Title order={6}>0.5</Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Trump[19])} />
          <Title order={6}>0.5</Title>
        </Stack>
      </Group>
      ...
      <Group justify="center" gap={0}>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Trump[0])} />
          <Title order={6}>4.5</Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Trump[20])} />
          <Title order={6}>4.5</Title>
        </Stack>
        <Stack align="center" gap={0}>
          <Image w={100} src={getCardUrl(Joker)} />
      ...
      <h3>Determing The Winners</h3>

      <p>
        When the play phase is finished, there will be two piles of cards. Each team should have their winnings and will
        begin counting how many points they have. While it is not necessary to count both since the counts have to sum
        to 91, it is commonly done in person to avoid errors.
      </p>
      ...
      <p>
        Another imporant detail is that meeting the threshold counts as a win. The point total must be below it to count
        as a loss.
      </p>
      ...
      <p>
        ...
        phase, starting with the dealer and moving counter-clockwise, each player makes a bid, which is either a number
        or a pass. The valid values to bid are 10, 20, 40, 80, 160. If someone has bid before you, you must bid higher,
        or pass. This means a bid of 160 effectively ends the bidding as no one else can bid higher.
      </p>

      <p>
        Bidding continues until all players but one have passed. That last player who bid is then considered the bidder
        moves on to a few things to setup the round.
      </p>

      <p>
        If you have previously bid, and the bidding comes back to you, you may choose to bid again, but if you pass, you
        can no longer again bid in this round.
      </p>

      <p>
        The incentive to become the bidder is driven by point. Whoever is the bidder stands to earn more points than the
        rest if he wins the round, but will be outnumbered by his opponents, and thus must have a stronger hand to
      ...
      <p>
        ...
        It is more of a wager, as it is a large factor in how many points will be won or lost at the end of a round.
        With a stronger hand, you will want to bid higher as you are more likely to win than lose, and so you want to
        wager more.
      </p>
      ...
      <p>
        A bidder can be his own partner, in which case they will have no partner and all four other players will be on a
        team against them. This is generally something to be avoided, buy can be lucrative in the right situations. If a
        player has all four kings in their hand, they may instead opt to call a queen instead, and so on for chevaliers
      ...
      <p>
        There is one special bid we allow called the Russian 20. It is a signal bid which indicates some of the cards in
        your hand to other players. It has the same value as the 20 bid, and can be bid in place of a 20.
      </p>
      ...
      <p>
        Once the partner card has been chosen, the bidder then deals with the dog. What he does depends on the value of
        his bid. This is the only mechanical effect the bid number has on the game.
      </p>
      ...
      <p>
        ...
        end of the game. However, it is a little harder to win as you don't get to make your hand stronger by exchanging
        cards.
      </p>
      ...
      <p>
        If the bidder bid 160, the cards stay hidden, but instead of going to the dealer, they will go to the opposition
        team, giving the bidder a points handicap. This is the most rewarding, but also most difficult bid to win.
      </p>

      <h3>Self-Call</h3>

      <p>
        As mentioned above, bidders can call themselves if they want to by choosing a king in their hand. However, they
        can also call themselves by chance if their king winds up in the dog. For 10, 20 and 40 bids, this information
        will be revealed right away, but in 80 and 160 bids, this will not be known until the end of the game.
      </p>

      <h3>Scoring</h3>

      <p>
        Once a round is over and the winner is determined, we determine how many points each player wins and loses. The
        first step is to calculate the score delta.
      </p>
      ...
      <h6>Points Over Threshold</h6>

      <p>
        If a bidder had 3 bout, and 52 points, their threshold was 36, so they exceeded it by 16, so the value for this
        is rounded up to 20.
      </p>
      ...
      <p>
        Once you have computed the score delta, you can then determine how much each player wins or loses. It is a zero
        sum-game, so the sum of all points exchanges should be zero.
      </p>
