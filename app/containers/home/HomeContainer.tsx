    ...
    <PageContainer>
      <Stack align="center" flex={1} mt={60}>
        ...
        <Stack gap="xs">
          ...
          <NavigationButton to={DynamicRoutes.results()} icon={<IconHistory />} color="blue" title="Results" />
          ...
          <NavigationButton to={StaticRoutes.addPlayer()} icon={<IconUser />} color="blue" title="Add New Player" />
          <NavigationButton to={StaticRoutes.bots()} icon={<IconRobot />} color="blue" title="Bots" />
          <NavigationButton to={StaticRoutes.tarothons()} icon={<IconStar />} color="blue" title="Tarothon" disabled />
