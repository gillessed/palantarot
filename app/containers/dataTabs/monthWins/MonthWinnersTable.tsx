...
export class MonthWinnersTable extends React.PureComponent<Props, {}> {
  ...
  private countMonthWinners(): MonthWinners[] {
    return this.props.groupedMonthlyScores.map((monthScores: MonthlyScore[]) => {
      return {
      ...
      if (!this.props.player) {
        ...
        return winners.first.playerId === id
          || winners.second.playerId === id
          || winners.third.playerId === id;
      }
    });
  }
}
