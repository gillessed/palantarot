    ...
    return (
      <div className="play-sidebar">
        <div className="sidebar-header">
          <img className="header-image" src={CardBackUrls.Blue} />
          <Button className="lobby-button" icon={IconNames.UNDO} onClick={this.returnToLobby} intent={Intent.PRIMARY} />
        </div>
        ...
        {sidebarTab === SidebarTab.Chat && <ChatList players={players} game={room.game} chat={room.chat} />}
        {sidebarTab === SidebarTab.Players && (
          <PlayerList
            selfId={playerId}
            players={players}
        ...
        <ChatInput player={this.props.room.playerId} dispatchers={this.props.dispatchers} />
        <SidebarActions room={this.props.room} dispatchers={this.props.dispatchers} />
      </div>
    );
  }
