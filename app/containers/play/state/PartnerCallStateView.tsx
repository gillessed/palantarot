    ...
    return (
      <>
        ...
        <g
          transform={`translate(${
            width / 2 + ButtonLeft
          }, ${y}) scale(0.1, 0.1) translate(-1150, 320) scale(0.1, -0.1)`}
          pointerEvents="none"
        >
        ...
        <g
          transform={`translate(${
            width / 2 + ButtonLeft + 120
          }, ${y}) scale(0.1, 0.1) translate(-140, 320) scale(0.1, -0.1)`}
          fill="#DB3737"
          pointerEvents="none"
        >
        ...
        <g
          transform={`translate(${
            width / 2 + ButtonLeft + 240
          }, ${y}) scale(0.1, 0.1) translate(-780, 320) scale(0.1, -0.1)`}
          fill="#137CBD"
          pointerEvents="none"
        >
        ...
        <g
          transform={`translate(${
            width / 2 + ButtonLeft + 360
          }, ${y}) scale(0.1, 0.1) translate(-450, 320) scale(0.1, -0.1)`}
          fill="#0F9960"
          pointerEvents="none"
        >
