...
export class GameRecordService {
  ...
  public getGamesInRange = (req: Request, res: Response) => {
    ...
    this.gameDb.queryGamesBetweenDates(startDate, endDate).then((results: GameRecord[]) => {
      res.send(results);
    }).catch((error: any) => {
  ...
  public getRecentGames = (req: Request, res: Response) => {
    ...
    this.gameDb.queryRecentGames(query).then((games: GameRecord[]) => {
      res.send(games);
    }).catch((error: any) => {
  ...
  public getGame = (req: Request, res: Response) => {
    ...
    this.gameDb.queryGameWithId(id).then((game: GameRecord) => {
      res.send(game);
    }).catch(() => {
