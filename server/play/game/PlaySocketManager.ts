...
import { Action, EnterGameAction, LeaveGameAction, PlayerEvent, PlayerId, PlayerNotReadyAction, PlayerReadyAction, Transition } from '../model/GameEvents';
...
export class PlaySocketManager {
  static Type = 'play';
  ...
  constructor(
    ...
    private gameQuerier: GameRecordQuerier,
  ...
  public addSocket(webSocket: JsonSocket, data: PlayMessage) {
    ...
    try {
      ...
      socket.sendPlayerEvents(this.playService.games.get(gameId)?.getEvents(playerId, 0, 100000).events || []);
